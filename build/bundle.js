...
var app = (function () {
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img = element("img");
    			if (img.src !== (img_src_value = /*gif*/ ctx[7])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", img_alt_value = "" + (/*name*/ ctx[0] + " gif"));
    			attr_dev(img, "width", "100%");
    			add_location(img, file, 39, 1, 1551);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*promise*/ 2 && img.src !== (img_src_value = /*gif*/ ctx[7])) {
    				attr_dev(img, "src", img_src_value);
    			}

    			if (dirty & /*name*/ 1 && img_alt_value !== (img_alt_value = "" + (/*name*/ ctx[0] + " gif"))) {
    ...
    // (37:16)   <p>"Loading GIF..."</p> {:then gif}
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "\"Loading GIF...\"";
    			add_location(p, file, 37, 1, 1514);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(37:16)   <p>\\\"Loading GIF...\\\"</p> {:then gif}",
    		ctx
    	});
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*handleInput*/ ctx[2], false, false, false)
    				];
    ...
    const url_base = "https://api.giphy.com/v1/gifs/random?api_key=iJVP0zYSmEKGwV29vvtpe6ghe207Jfsq&tag=";
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [name, promise, handleInput, input_input_handler];
    }
